...
class NodeCallback:
    ...
    result: Optional[Any] = field(default=None, metadata={"description": "回调函数返回的结果"})
...
def node_callback(method_name: str):
    """ 装饰器，用于注册回调方法 """
    def decorator(func):
        NodeCallbackRegister._callbacks[method_name] = func
        return func
    return decorator