...
from catena_core.callback.node_callbacks import NodeCallbackRegister as Register
from catena_core.alias.builtin import NodeCompletionType, NodeType, MemoryType
...
class InfMemory(Memory):
    ...
    _id: Enum = field(default=NodeType.MOM, init=False, metadata={"disciption": "节点id"})
    ...
    def __post_init__(self):
        if self.system_prompt:
            self.system_message = [PromptRole.system(prompt) for prompt in self.system_prompt]
    ...
    @Register.node_callback("update_memory")
