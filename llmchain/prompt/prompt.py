...
from catena_core.alias.builtin import NodeCompletionType, NodeType
    ...
    def operate(
        ...
        def _simple_invoke(input, config = None, *args, **kwargs) -> list:
            ...
            if isinstance(input, str):
                message = [*self.message, PromptRole.user(input)]
                return message
        ...
        return NodeCompletion(NodeCompletionType.LLMIP, output_messages, config=config)
