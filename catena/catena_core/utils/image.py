...
""" 
————————————————————————————————————————————————————————————————
        Image Processing Helper Functions for Model classs      
————————————————————————————————————————————————————————————————
"""
           
def process_string_image(image: str) -> Dict[str, Any]:
...
def process_bytes_image(image: bytes) -> Dict[str, Any]:
...
def process_model_image(image: Any) -> Optional[Dict[str, Any]]:
    ...
    if isinstance(image, str):
        return process_string_image(image)

    if isinstance(image, bytes):
        return process_bytes_image(image)
